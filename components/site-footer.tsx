...
export function SiteFooter({ brandName = "Wingman Pro" }: SiteFooterProps) {
  return (
    <footer className="border-t border-[#6668A1A1] bg-[#D4D5FB] py-12 md:py-16 public-theme">
      ...
      <div className="mx-auto max-w-8xl px-6 mt-12 pt-6 border-t-[0.5px] border-[#6668A1A1] flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="text-xs text-[#6668A1]/80 text-center md:text-left">
