      ...
      <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-slate-600 dark:text-slate-300">
        ...
        <div className="flex flex-col gap-6">
          ...
          <nav className="flex flex-col gap-4 text-base font-bold">
            ...
            <Link href="/child-safety" className="hover:text-sky-600 dark:hover:text-sky-400 transition-colors">Child Safety &amp; CSAE</Link>
            <Link href="/delete-account" className="hover:text-sky-600 dark:hover:text-sky-400 transition-colors">Data deletion request</Link>
