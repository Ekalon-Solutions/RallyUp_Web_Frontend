...
export function EventFeeManagementSection({
  ...
  const fees = gross > 0 ? calculateTransactionFees(gross) : null
  ...
  const netPerTicket =
    value === "absorb" ? estimateNetPerTicket(gross) : gross
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <Tooltip>
                ...
                <TooltipContent side="top" className="max-w-xs text-left space-y-1">
                  ...
                  <p>Platform fee: {PLATFORM_FEE_PERCENT}% + {GST_PERCENT}% GST</p>
