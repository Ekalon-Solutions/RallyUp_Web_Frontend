...
export default function RefundPage(): React.JSX.Element {
 ...
 <span className="text-[10px] font-medium leading-[14px] text-primary uppercase tracking-normal">Refund Policy</span>
 </div>
 <h1 className="text-3xl md:text-4xl font-bold z-10 relative mb-4">REFUND AND CANCELLATION POLICY</h1>
 ...
 <h2 className="text-xl font-semibold text-secondary">2. Role of the Platform</h2>
 <p>
 ...
 <h2 className="text-xl font-semibold text-secondary">3. Eligibility for Refunds</h2>
 <p>
 ...
 <h2 className="text-xl font-semibold text-secondary">4. Non-Refundable Components</h2>
 <p>
 ...
 <h2 className="text-xl font-semibold text-secondary">5. Processing and Timelines</h2>
 <ul className="list-disc pl-5 space-y-2">
 ...
 <h2 className="text-xl font-semibold text-secondary">6. Club-Specific Policies</h2>
 <ul className="list-disc pl-5 space-y-2">
 ...
 <h2 className="text-xl font-semibold text-secondary">7. Fulfilment and Disputes</h2>
 <ul className="list-disc pl-5 space-y-2">
 ...
 <h2 className="text-xl font-semibold text-secondary">8. Amendments to Policy</h2>
 <ul className="list-disc pl-5 space-y-2">
 ...
 <h2 className="text-xl font-semibold text-secondary">9. Contact Information</h2>
 <p>
